import { Flex, ListItem, Text, OrderedList } from '@chakra-ui/layout';
...
const Page: NextAppPage = () => (
  ...
  >
    ...
    <Text>
      この利用規約（以下，「本規約」といいます。）は，Tubetter（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。本サービスをご利用になる方は、本利用規約に同意する前に、必ず全文お読み下さいますようお願い致します。
    </Text>
    <Item>
